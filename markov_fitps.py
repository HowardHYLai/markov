...
path = r"C:\NILM\DATA\DATA\0001Vacuum\0001Vacuum new.csv"
...
#     plt.imshow(y[i])
    ...
    plt.savefig(r"C:\NILM\pictur_for_code\低功率電器\612\FITPS\關閉\0001Vacuum/{}.png".format(i)) #输入地址，并利用format函数修改图片名称
